-------------------------------------------------------------------------------
-- ##Coroutine API
-- This [coroutine API](http://www.lua.org/manual/5.1/manual.html#2.11) is a 
-- reimplementation of the default Lua coroutine library with some features trimmed.
-- @module coroutine
...
-- `resume` returns `false` plus the error `string`.
...
-- @return #boolean, #Untyped `true` plus any values passed to `yield` (if the coroutine yields) or any values returned
-- by the body function (if the coroutine terminates)
-- @return #boolean, #string `false` plus an error `string`.
...
-- @param f a `function` used as `coroutine` body. 
-- @param ... arguments passed to the body `function` or as result of `yield` call.
-- @return #Untyped Any values passed to `yield` (if the coroutine `yields`) or any values returned
-- by the body `function` (if the `coroutine` terminates).
...
-- @return #Untyped Any values passed to the `resume` function.
